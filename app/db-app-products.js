const DB_APP_PRODUCTS = [  
    {
        product: {
            ...
            id: '800',
            imgSrc: './assets/products-img/bakeneko-new.jpg',
            imgAlt: {
            ...
            ingredients: [
                {
                    text: {
                        ces: 'ořechový čokoládový tavený sýr',
                        eng: 'nut chocolate cream cheese',
                        ukr: 'горіхово-шоколадний вершковий сир',
                        rus: 'орехово-шоколадный сливочный сыр'
                    }
                },
                {
                    text: {
                ...
                {
                    text: {
                        ces: 'čokoládovou polevou',
                        eng: 'chocolate topping',
                        ukr: 'шоколадний топінг',
                        rus: 'шоколадный топпинг'
                    }
                },
                {
                    text: {
                        ces: 'okvětní lístky mandlí',
                        eng: 'almond petals',
                        ukr: 'пелюстки мигдалю',
                        rus: 'лепестки миндаля'
                    }
                },
            ],
            weight: 250,
        ...
        product: {
            ...
            id: '801',
            imgSrc: './assets/products-img/yukionna-new.jpg',
            imgAlt: {
                ces: 'Fotografie rohlíků',
                eng: 'Photo rolse',
                ukr: 'Фото роллів',
            ...
            ingredients: [
                {
                    text: {
                        ces: 'kokosový tavený sýr',
                        eng: 'coconut cream cheese',
                        ukr: 'кокосовий вершковий сир',
                        rus: 'кокосовый сливочный сыр'
                    }
                },
                {
                    text: {
                ...
                {
                    text: {
                        ces: 'karamelovou polevou',
                        eng: 'caramel topping',
                        ukr: 'карамельний топінг',
                        rus: 'карамельный топпинг'
                    }
                },
                {
                    text: {
                        ces: 'kokosové vločky',
                        eng: 'coconut flakes',
                        ukr: 'кокосова стружка',
                        rus: 'кокосовая стружка'
                    }
                },
            ],
            weight: 250,
